...
oboe = \relative c'' {
  ...
  %20
  d4f, bes d |f2 bes,8 d f bes| g g f f es es d d | c c bes bes a bes bes8._+(a32 bes)| c8 bes a_+ g  f es d c|  es2 bes'8 es, bes' g|
  %26
  ...
  %45
  e b b'4 r2| e,2 a,8 cis e f | d a a'2.~| a4 g8-+ f e f e cis | d c bes a g fis e d_\markup \italic {"D.S."\segno"al Fine."}  \bar "||"
